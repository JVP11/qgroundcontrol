...
SetupPage {
    ...
    Component {
        ...
        ColumnLayout {
            ...
            property Fact _rateRollP:           controller.getParameterFact(-1, "ATC_RAT_RLL_P", false)
            property Fact _rateRollI:           controller.getParameterFact(-1, "ATC_RAT_RLL_I", false)
            property Fact _ratePitchP:          controller.getParameterFact(-1, "ATC_RAT_PIT_P", false)
            property Fact _ratePitchI:          controller.getParameterFact(-1, "ATC_RAT_PIT_I", false)
            property Fact _rateClimbP:          controller.getParameterFact(-1, "PSC_ACCZ_P", false)
            property Fact _rateClimbI:          controller.getParameterFact(-1, "PSC_ACCZ_I", false)
            property Fact _motSpinArm:          controller.getParameterFact(-1, "MOT_SPIN_ARM", false)
            property Fact _motSpinMin:          controller.getParameterFact(-1, "MOT_SPIN_MIN", false)
